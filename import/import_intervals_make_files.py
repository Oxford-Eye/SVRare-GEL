...
def main(args):
    ...
    out_handles = {
            'Interval': open(args.interval_output, 'wt'),
            'Interval_Gene': open(args.interval_gene_output, 'wt'),
            'Patient_Interval': open(args.patient_interval_output, 'wt'),
            'Group': open(args.group_output, 'wt'),
            'Interval_Group': open(args.interval_group_output, 'wt'),
    }
    # headers for outputs
        ...
        for line in inf:
            ...
            for super_group in intervals_super_group:
                ...
                for interval in super_group.intervals:
                    ...
                    for gene_id in all_intervals[interval.interval_id]['genes']:
                        interval_gene_output = {
                                'interval_id': interval.interval_id,
                                'gene_id': gene_id,
                                'at_bnd': gene_id in all_intervals[interval.interval_id]['genes_at_bnd'],
                        }
...
if __name__ == '__main__':
    ...
    parser.add_argument('--interval_output', dest='interval_output')
    parser.add_argument('--interval_gene_output', dest='interval_gene_output')
    parser.add_argument('--group_output', dest='group_output')
    parser.add_argument('--patient_interval_output', dest='patient_interval_output')
    parser.add_argument('--interval_group_output', dest='interval_group_output')
